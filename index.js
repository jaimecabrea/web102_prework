...
const totalNumberGames = GAMES_JSON.length;
gamesCard.innerHTML = 
`
    <p>${totalNumberGames.toLocaleString()}</p>
`;
...
const displayStr = `A total of $${totalAmountRaised.toLocaleString()} has been raised for ${totalNumberGames} ${totalNumberGames> 1 ? "games" : "game"}.
...
runnerUpElement.innerHTML = `<h3>${runnerUpGame.name}</h3>`;
